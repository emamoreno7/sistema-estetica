...
export default function ClientLoginPage() {
  return (
    <div className="relative min-h-screen px-5 py-12 sm:px-8" style={{ background: 'var(--bg-cream)' }}>
      ...
      <div className="relative z-10 mx-auto max-w-md">
        <Link
          to="/"
          className="text-[10px] font-semibold uppercase tracking-[0.2em] text-[var(--primary-navy)]/65 underline underline-offset-4"
        >
          ← Inicio
        </Link>
        <motion.div
        ...
        >
          <h1 className="text-serif-premium text-2xl font-light text-[var(--primary-navy)]">Bienvenida de nuevo</h1>
          <p className="mt-2 text-sm text-[var(--primary-navy)]/60">
