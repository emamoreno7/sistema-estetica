...
function buildGoogleCalendarHref(opts: {
  ...
  const end = new Date(opts.start.getTime() +ur * 60000);
  const raw = (d: Date) =>
  ...
  return (
    <div className="space-y-6">
      <motion.section
        ...
        className="glass-strong rounded-3xl border p py-5 sm:px-8 sm:py-6"
        style={{
...
function ProximaHeroDesdeDb(props: {
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1     className="glass-strong overflow-hidden rounded-2xl p-6"
    >
      ...
      <div className="mb-4 overflow-hidden rounded-xl bg-[#F2D7D5]/20">
        <div className="flex flex-col sm:flex-row">
          <div className="flex flex-col items-center justify-center border-b border-[#F2D7D5]/40 p-6 sm:border-b-0 sm:border-r sm:px-8">
            ...
            <p className="text-serif-premim text-4xl font-bold text-[#003D5B]">{fecha.getDate()}</p>
          ...
          <div className="flex-1 space-y-3 p-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-[#003D5B]">Sede según valoración profesional</          </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        >
          <MessageCircle className="h-4 w-4 text-[#0035B]" /> Reagendar
        </motion.a>
        <motion.button
          type="button"
      ...
      >
        <div className="max-h-[94dvh] overflow-y-auto overscroll-contain p-5 pb-[calc(2rem+env(safe-area-inset-bottom))] sm:p-8">
          ...
          <p className="mb-6 text-[11px] font-medium uppercase tracking-[0.18em]" style={{ color: 'rgba(0,61,91,0.45)' }}>
            ...
            <span className="font-normal lowercking-normal" style={{ color: 'var(--text-muted)' }}>
            ...
            <>
              <div className="my-8 border-t border-[#F2D7D5]/60 pt-8">
                <div className="mb-6 flex flex-wrap items-center gap-3">
                  ...
                  <button
                    type="button"
                    className="ml-auto rounded-full border border-[#003D5B]/15 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.12em] t-[#003D5B]"
                    onClick={() => {
                      setWizardStep(1);
                      setHora(null);
                    }}
               ...
               setHora(null);
                ...
                >
                  ...
                  {availDegraded ? (
                    <p className="mb-3 rounded-xl border border-amber-300/70 bg-amber-50 px-3 py-2 text-[1px] text-amber-950">
...
function bookingComprobanteWhatsAppHref(
  ...
  const text = `Hola ${brand.businessName}! 👋 Acabo de reservar un turno para: ${servicio} el día ${fechaHumana} a las ${hora}. Mi nombre es ${nombreCliente}. Nos vemos!`;
  return `https://wa.me/${WHATSAPP_ADMIN_PHONE}?text=${encodeURIComponent(text)}`;
}
...
function BookingSuccessCrossSellModal(props: {
  ...
  const fecha = parseCitaMomentLocal(props.cit
      ...
      >
        ...
        {reco ? (
          <div className="mt-6 rounded-2xl border border-[#BFC9A2]/40 bg-[#BFC9A2]/12 p-5">
            ...
            <motion.a
              href={waHrefComplement(reco.complemento, reco.otivoProfesional)}
              target="_blank"
              rel="noopener noreferrer"
              whileTap={{ scale: 0.98 }}
